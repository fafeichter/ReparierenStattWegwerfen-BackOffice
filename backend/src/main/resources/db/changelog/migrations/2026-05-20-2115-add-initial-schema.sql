...
CREATE TABLE apple_silicon
(
    apple_silicon_id         int          NOT NULL AUTO_INCREMENT,
    ...
    PRIMARY KEY (apple_silicon_id),
    UNIQUE KEY uq_apple_silicon_name (name)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE apple_silicon_unified_memory
(
    apple_silicon_unified_memory_id int       NOT NULL AUTO_INCREMENT,
    size                            smallint  NOT NULL,
    unit                            char(2)   NOT NULL,
    created_at                      timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at                      timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (apple_silicon_unified_memory_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(
    device_invoice_id int       NOT NULL AUTO_INCREMENT,
    number            int       NOT NULL,
    date              date      NOT NULL,
    created_at        timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at        timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (device_invoice_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE online_marketplace
(
    online_marketplace_id int          NOT NULL AUTO_INCREMENT,
    name                  varchar(256) NOT NULL,
    url                   varchar(256) NOT NULL,
    created_at            timestamp    NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at            timestamp    NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (online_marketplace_id),
...
(
    ...
    apple_silicon_id                 int       NOT NULL,
    created_at                       timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at                       timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (model_available_apple_silicon_id),
    UNIQUE KEY uq_maas_model_silicon (model_id, apple_silicon_id),
    KEY                              idx_maas_apple_silicon_id (apple_silicon_id),
    CONSTRAINT fk_maas_apple_silicon_id FOREIGN KEY (apple_silicon_id) REFERENCES apple_silicon (apple_silicon_id) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
(
    ...
    model_available_apple_silicon_id          int       NOT NULL,
    apple_silicon_unified_memory_id           int       NOT NULL,
    created_at                                timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at                                timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (model_silicon_available_unified_memory_id),
    UNIQUE KEY uq_msaum_silicon_memory (model_available_apple_silicon_id, apple_silicon_unified_memory_id),
    KEY                                       idx_msaum_memory_id (apple_silicon_unified_memory_id),
    ...
    CONSTRAINT fk_msaum_memory FOREIGN KEY (apple_silicon_unified_memory_id) REFERENCES apple_silicon_unified_memory (apple_silicon_unified_memory_id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(
    ...
    model_id                        int            NOT NULL,
    apple_silicon_id                int                     DEFAULT NULL,
    apple_silicon_unified_memory_id int                     DEFAULT NULL,
    ...
    purchase_online_marketplace_id  int            NOT NULL,
    selling_online_marketplace      int                     DEFAULT NULL,
    ...
    device_invoice_id               int                     DEFAULT NULL,
    created_at                      timestamp      NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at                      timestamp      NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (device_id),
    KEY                             idx_device_model_id (model_id),
    KEY                             idx_device_apple_silicon_id (apple_silicon_id),
    KEY                             idx_device_unified_memory_id (apple_silicon_unified_memory_id),
    ...
    KEY                             idx_device_purchase_om_id (purchase_online_marketplace_id),
    ...
    KEY                             idx_device_invoice_id (device_invoice_id),
    KEY                             idx_device_selling_om (selling_online_marketplace),
    KEY                             idx_device_battery_status_id (device_battery_status_id),
    CONSTRAINT fk_device_apple_silicon_id FOREIGN KEY (apple_silicon_id) REFERENCES apple_silicon (apple_silicon_id) ON DELETE RESTRICT ON UPDATE RESTRICT,
    ...
    CONSTRAINT fk_device_device_invoice_id FOREIGN KEY (device_invoice_id) REFERENCES device_invoice (device_invoice_id) ON DELETE RESTRICT ON UPDATE RESTRICT,
    ...
    CONSTRAINT fk_device_purchase_om_id FOREIGN KEY (purchase_online_marketplace_id) REFERENCES online_marketplace (online_marketplace_id) ON DELETE RESTRICT ON UPDATE RESTRICT,
    ...
    CONSTRAINT fk_device_selling_om_id FOREIGN KEY (selling_online_marketplace) REFERENCES online_marketplace (online_marketplace_id) ON DELETE RESTRICT ON UPDATE RESTRICT,
    ...
    CONSTRAINT fk_device_unified_memory_id FOREIGN KEY (apple_silicon_unified_memory_id) REFERENCES apple_silicon_unified_memory (apple_silicon_unified_memory_id) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
